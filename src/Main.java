...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        StatybininkasImp st1 = new StatybininkasImp(10, "Profesinis", "Statyba", 753.99, "vyr", 35511010001L, "Petras", "Petraitis", 64, 172, "ruda");
        System.out.println("Statybininko " + st1.getVardas() + " " + st1.getPavarde() + " amžius: " + st1.getAmzius() + "m. Stažas: " + st1.getStazas());
    }
}
